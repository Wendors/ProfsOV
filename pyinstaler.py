...
icons = "Profico"
num = 2
# для експорту бібліотеки в Windows
...
# для експорту бібліотеки в Linux
pathlibs = os.environ["VIRTUAL_ENV"] + "/lib/python3.10/site-packages/"
if str(num) == "1":
...
if sys.platform == 'win32':
    ...
    os.system("pyinstaller  {0}  --icon={1}.ico  {2}.py --name={3} --paths={4}".format(pacs, icons, scripts, names, pathlibs))
