...
class Window(QtWidgets.QWidget):
    ...
    def __init__(self, titles):
        ...
        if "ANDROID_BOOTLOGO" in os.environ:
            self.move(
                int((self.resolution.width() / 2) - (self.frameSize().width() / 2)),
                int(0),
            )
        else:
            self.move(
    ...
    def handlePrint(self):
        ...
        if "ANDROID_BOOTLOGO" in os.environ:
            ...
            if self.orient == 1:
                ...
                printerd.setPageMargins(
                    30, 10, 10, 20, QtPrintSupport.QPrinter.Millimeter
                )
    ...
    def handlePreview(self):
        ...
        if "ANDROID_BOOTLOGO" in os.environ:
            ...
            printerd = QtPrintSupport.QPrinter(
    ...
    def topdf(self):
        ...
        self.files = QtWidgets.QFileDialog.getSaveFileName(
            self, "Зберегти дані", self.sevs, "PDF (*.pdf)"
        )
    ...
    def Wordtext(self):
        ...
        self.rung.add_picture(
            "{0}".format(self.pathtemp + self.gnam), width=Cm(1.3), height=Cm(1.7)
        )
        ...
        self.run3.add_text(
            " с. Іванчі Вараського району Рівненської  області, 34375тел. 2-53-24; 5-31-49,"
            "тел./факс 5-35-46"
        )
        ...
        self.rpa1.bold = True
        self.rpa1.add_text(
            "Начальнику Західного міжрегіонального управління з"
        ...
        self.rtext.add_tab()
        self.rtext.add_text(
            "На виконання вказівки Західного міжрегіонального управління"
                ...
                if i == "Напад":
                    ...
                    for ip in self.proerss:
                        ...
                        if str(ip) == str(i):
                            ...
                            self.p_ob.paragraph_format.line_spacing_rule = (
                            ...
                            self.p_obp.paragraph_format.line_spacing_rule = (
                                WD_LINE_SPACING.SINGLE
                            )
