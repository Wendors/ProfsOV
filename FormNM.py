...
class Ui_FormN(object):
    ...
    def retranslateUi(self, FormN):
        ...
        self.label_36.setText(_translate("FormN", "Стаття КК України"))
        ...
        self.comboBox_5.setItemText(11, _translate("FormN", "Злочинний вплив"))
        self.comboBox_5.setItemText(12, _translate("FormN", "Лідер ОЗГ"))
        self.comboBox_5.setItemText(13, _translate("FormN", "Масові заворушення"))
        self.comboBox_5.setItemText(14, _translate("FormN", "Напад"))
        self.comboBox_5.setItemText(15, _translate("FormN", "Наркоділки з міжрегіональними звязками"))
        self.comboBox_5.setItemText(16, _translate("FormN", "Нецільове використання бюджетних коштів"))
        self.comboBox_5.setItemText(17, _translate("FormN", "Організація азартних ігор під матеріалну зацікавленість"))
        self.comboBox_5.setItemText(18, _translate("FormN", "Проти основ національної безпеки"))
        ...
        self.comboBox_6.setItemText(10, _translate("FormN", "ДПВ"))
        self.comboBox_6.setItemText(11, _translate("FormN", "ДПК"))
